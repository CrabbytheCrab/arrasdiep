    ...
    handleIncoming(header, data) {
        ...
        switch (header) {
            case 1: {
                ...
                if (flags & 256) {
                    if ((this.accessLevel === 3) || (camera.cameraData.values.level < config.maxPlayerLevel && ((this.game.arena.arenaData.values.flags & 16) || (this.accessLevel === 2) || (this.accessLevel === 0)))) {
                        this.setHasCheated(true);
