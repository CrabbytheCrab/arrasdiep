...
const Egg_1 = __importDefault(require("../Shape/Egg"));
...
class TankBody extends Live_1.default {
    ...
    onKill(entity) {
        ...
        if (entity instanceof Egg_1.default && this.definition.flags.canClaimEggs && this.barrels.length) {
            const MAX_DRONES_PER_BARREL = 11 + this.cameraEntity.cameraData.values.statLevels.values[1];
            ...
            if (barrelsToShoot.length) {
                ...
                const sunchip = NecromancerEgg_1.default.fromShape(barrelToShoot, this, this.definition, entity);
            }
        }
    }
    ...
    tick(tick) {
        ...
        if (this._currentTank == 64 && this.bool) {
            this.bool = false;
