...
const Block_1 = __importDefault(require("./Projectile/Block"));
const Launrocket_1 = __importDefault(require("./Projectile/Launrocket"));
const ShotGun_1 = __importDefault(require("./Projectile/ShotGun"));
const Hive_1 = __importDefault(require("./Projectile/Hive"));
const AutoDrone_1 = __importDefault(require("./Projectile/AutoDrone"));
const NecromancerEgg_1 = __importDefault(require("./Projectile/NecromancerEgg"));
const Boomer_1 = __importDefault(require("./Projectile/Boomer"));
const EngiBlock_1 = __importDefault(require("./Projectile/EngiBlock"));
const CombineBlock_1 = __importDefault(require("./Projectile/CombineBlock"));
const Conglom_1 = __importDefault(require("./Projectile/Conglom"));
const MegaSpinner_1 = __importDefault(require("./Projectile/MegaSpinner"));
class ShootCycle {
    constructor(barrel) {
...
class Barrel extends Object_1.default {
    ...
    shoot() {
        ...
        switch (this.definition.bullet.type) {
            case "skimmer":
                new MegaSpinner_1.default(this, this.tank, tankDefinition, angle, this.tank.inputs.attemptingRepel() ? -MegaSpinner_1.default.BASE_ROTATION : MegaSpinner_1.default.BASE_ROTATION);
                break;
            case "conglom":
                new Conglom_1.default(this, this.tank, tankDefinition, angle, this.tank.inputs.attemptingRepel() ? -Conglom_1.default.BASE_ROTATION : Conglom_1.default.BASE_ROTATION);
                break;
            case "glider":
            ...
            case 'bullet': {
                ...
                if (tankDefinition && (tankDefinition.id === 10004 || tankDefinition.id === -7))
            ...
            case 'trap':
                ...
                break;
            case 'drone':
                new Drone_1.default(this, this.tank, tankDefinition, angle, this.rootParent);
                break;
            case 'necrodrone':
                new NecromancerSquare_1.default(this, this.tank, tankDefinition, angle);
                break;
            case 'eggdrone':
                new NecromancerEgg_1.default(this, this.tank, tankDefinition, angle);
                break;
            case 'swarm':
            ...
            case "autodrone":
                ...
                break;
            case "block":
                new Block_1.default(this, this.tank, tankDefinition, angle, this.rootParent);
                break;
            case "boomer":
                new Boomer_1.default(this, this.tank, tankDefinition, angle, this.rootParent);
                break;
            case "engi":
                new EngiBlock_1.default(this, this.tank, tankDefinition, angle, this.rootParent);
                break;
            case "assblock":
                new CombineBlock_1.default(this, this.tank, tankDefinition, angle, this.rootParent);
                break;
            default:
